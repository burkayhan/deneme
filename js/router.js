...
# ============================================
# 9. router.js — Client-Side Router
# ============================================
router_js = '''/* ═══════════════════════════════════════════
   AURA AI OS — Router
...
const AuraRouter = (function() {
  'use strict';

  // ── Route Definitions ──
  const routes = {
    'dashboard': { title: 'Dashboard', icon: 'layout-dashboard', section: 'main' },
    'chat': { title: 'Chat', icon: 'message-square', section: 'main' },
    'multi-chat': { title: 'Multi Model Chat', icon: 'layers', section: 'main' },
    'models': { title: 'Model Marketplace', icon: 'shopping-bag', section: 'main' },
    'installed': { title: 'Installed Models', icon: 'download', section: 'main' },
    'cloud': { title: 'Cloud Models', icon: 'cloud', section: 'main' },
    'local': { title: 'Local Models', icon: 'hard-drive', section: 'main' },
    'agents': { title: 'Agents', icon: 'bot', section: 'main' },
    'memory': { title: 'Memory', icon: 'brain', section: 'main' },
    'knowledge': { title: 'Knowledge Base', icon: 'book-open', section: 'main' },
    'vector-db': { title: 'Vector Database', icon: 'database', section: 'main' },
    'workflows': { title: 'Workflows', icon: 'git-branch', section: 'automation' },
    'automation': { title: 'Automation', icon: 'zap', section: 'automation' },
    'prompts': { title: 'Prompt Library', icon: 'bookmark', section: 'automation' },
    'documents': { title: 'Documents', icon: 'file-text', section: 'content' },
    'projects': { title: 'Projects', icon: 'folder', section: 'content' },
    'files': { title: 'Files', icon: 'file', section: 'content' },
    'image-gen': { title: 'Image Generation', icon: 'image', section: 'content' },
    'voice': { title: 'Voice', icon: 'mic', section: 'content' },
    'analytics': { title: 'Analytics', icon: 'bar-chart-2', section: 'monitoring' },
    'performance': { title: 'Performance', icon: 'activity', section: 'monitoring' },
    'gpu-monitor': { title: 'GPU Monitor', icon: 'cpu', section: 'monitoring' },
    'cpu-monitor': { title: 'CPU Monitor', icon: 'cpu', section: 'monitoring' },
    'ram-monitor': { title: 'RAM Monitor', icon: 'hard-drive', section: 'monitoring' },
    'storage': { title: 'Storage', icon: 'disc', section: 'monitoring' },
    'logs': { title: 'Logs', icon: 'scroll-text', section: 'monitoring' },
    'console': { title: 'Console', icon: 'terminal', section: 'monitoring' },
    'notifications': { title: 'Notifications', icon: 'bell', section: 'system' },
    'plugins': { title: 'Plugins', icon: 'puzzle', section: 'system' },
    'extensions': { title: 'Extensions', icon: 'plug', section: 'system' },
    'settings': { title: 'Settings', icon: 'settings', section: 'system' },
    'developer': { title: 'Developer Mode', icon: 'code', section: 'system' },
    'admin': { title: 'Admin Panel', icon: 'shield', section: 'system' },
    'api-keys': { title: 'API Keys', icon: 'key', section: 'system' },
    'team': { title: 'Team Workspace', icon: 'users', section: 'system' },
    'permissions': { title: 'Permissions', icon: 'lock', section: 'system' },
    'security': { title: 'Security Center', icon: 'shield-check', section: 'system' },
    'task-queue': { title: 'Task Queue', icon: 'list', section: 'system' },
    'jobs': { title: 'Background Jobs', icon: 'clock', section: 'system' },
    'scheduler': { title: 'Scheduler', icon: 'calendar', section: 'system' },
    'model-router': { title: 'Model Router', icon: 'route', section: 'system' },
    'health': { title: 'System Health', icon: 'heart-pulse', section: 'system' },
    'cost': { title: 'Cost Tracking', icon: 'dollar-sign', section: 'system' },
    'usage': { title: 'Usage Statistics', icon: 'pie-chart', section: 'system' },
    'live-monitor': { title: 'Live Monitoring', icon: 'radio', section: 'system' }
  };
  ...
  const navStructure = [
    {
      title: 'Ana',
      items: ['dashboard', 'chat', 'multi-chat']
    },
    {
      title: 'Modeller',
      items: ['models', 'installed', 'cloud', 'local']
    },
    {
      title: 'AI Ajanları',
      items: ['agents', 'memory', 'knowledge', 'vector-db']
    },
    {
      title: 'Otomasyon',
      items: ['workflows', 'automation', 'prompts']
    },
    {
      title: 'İçerik',
      items: ['documents', 'projects', 'files', 'image-gen', 'voice']
    },
    {
      title: 'İzleme',
      items: ['analytics', 'performance', 'gpu-monitor', 'cpu-monitor', 'ram-monitor', 'storage', 'logs', 'console']
    },
    {
      title: 'Sistem',
      items: ['notifications', 'plugins', 'extensions', 'settings', 'developer', 'admin', 'api-keys', 'team', 'permissions', 'security', 'task-queue', 'jobs', 'scheduler', 'model-router', 'health', 'cost', 'usage', 'live-monitor']
    }
  ];
  ...
  // ── SVG Icon Map ──
  const icons = {
    'layout-dashboard': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="9"/><rect x="14" y="3" width="7" height="5"/><rect x="14" y="12" width="7" height="9"/><rect x="3" y="16" width="7" height="5"/></svg>',
    ...
    'shopping-bag': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',
    ...
    'scroll-text': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>',
    ...
    'puzzle': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z"/></svg>',
    'plug': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>',
    'settings': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.67 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.67a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',
    ...
    'shield-check': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 12 15 16 10"/></svg>',
    ...
    'route': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="19" r="3"/><circle cx="18" cy="5" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.12" y1="17.88" x2="15.88" y2="10.12"/><line x1="15.88" y1="17.88" x2="8.12" y2="10.12"/></svg>',
    ...
    'pie-chart': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>',
  ...
  function getRoute(routeId) {
    return routes[routeId] || { title: 'Sayfa', icon: 'layout-dashboard', section: 'main' };
  }
  ...
  function navigateTo(routeId, pushState = true) {
    if (!routes[routeId]) {
      console.warn(`Route "${routeId}" not found, redirecting to dashboard`);
      routeId = 'dashboard';
    }
    ...
    document.title = `${routes[routeId].title} — Aura AI OS`;

    // Update breadcrumb
    updateBreadcrumb(routeId);

    // Update active nav
    updateActiveNav(routeId);

    // Execute route handler if registered
    if (routeHandlers[routeId]) {
      routeHandlers[routeId]();
    }

    // Dispatch custom event
    window.dispatchEvent(new CustomEvent('auraroutechange', {
      detail: { route: routeId, routeData: routes[routeId] }
    }));

    return routes[routeId];
  }

  function updateBreadcrumb(routeId) {
  ...
  function registerRouteHandler(routeId, handler) {
    routeHandlers[routeId] = handler;
  }
